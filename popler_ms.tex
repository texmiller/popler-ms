...
The \texttt{popler} database currently contains data from 325 studies (136 of which are experimental) representing 4421 cumulative years of observations with a mean study duration of 13.6 years. \texttt{popler} contains data from 676 plant species, 347 animal species, and 1 fungal species.
